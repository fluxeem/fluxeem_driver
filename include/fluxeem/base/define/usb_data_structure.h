...
#define USB_FAILURE_FLAG (0x80000000) /* Sent by device when a command fails */
#define USB_WRITE_FLAG (0x40000000)   /* Add to a property to request write */

#define USB_UNKNOWN_CMD (0 | USB_FAILURE_FLAG) /* Command not implemented */
