...
#ifndef Imx636_REGISTERS_INFO_H
#define Imx636_REGISTERS_INFO_H

#include <fluxeem/hal/registers/init_registers_info/register_info.h>

#define IMX636_REGISTER_PREFIX ("PSEE/IMX636/")

static RegisterInfo Imx636RegisterInfos[] = {
    // clang-format off
...
static uint32_t Imx636RegisterInfoNum = sizeof(Imx636RegisterInfos) / sizeof(Imx636RegisterInfos[0]);

#endif // Imx636_REGISTERS_INFO_H
