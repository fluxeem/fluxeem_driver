...
{
    /// @brief
    /// @param index: index of the uint32_t to return, starting from data field
    /// @return value of the uint32_t at index
    ...
    std::vector<std::string> StringsCtrlFrame::getStrings()
    {
        ...
        // CtrlFrame already checked request status
        ...
        // There could be multiple strings in the frame, separated by NULL
        while (remaining)
        {
